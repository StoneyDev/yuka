...
export function getQualityDetails (qualityType, value: number): { quality: QualityGrades; label: string } {
...
export function getOverallQuality (product): { label: QualityGrades; value: number; } {
    let score = 0;
